...
- `active_iam` (String) The IAM (Identity and Access Management) role associated with the EOS resource.[Get iams here](https://registry.terraform.io/providers/e2eterraformprovider/tir/latest/docs/resources/integration) [Terraform Docs](https://registry.terraform.io/providers/e2eterraformprovider/tir/latest/docs/resources/integration)
